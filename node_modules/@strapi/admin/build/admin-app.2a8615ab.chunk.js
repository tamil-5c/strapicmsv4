...
`;p.Z=E},24436:function(w,p,t){"use strict";var e=t(32735),g=t(10369),E=t(27649),v=t(72850),u=t(49372),f=t(87933),N=t(8284),Z=t(41415),C=t(45509),W=t(54894),j=t(60492),X=t(92802),T=t(60216),M=t.n(T),q=t(67879),Pe=t(8471),i=t(73678),be=t(11060),a=t(24018);const Se=(0,Pe.ZP)(g.o)`
  ::-ms-reveal {
    display: none;
  }
`,Te=({onSubmit:Ne,schema:De,children:Je})=>{const[We,Qe]=(0,e.useState)(!1),{formatMessage:oe}=(0,q.Z)();return e.createElement(E.o,null,e.createElement(be.bU,null,e.createElement(X.J9,{enableReinitialize:!0,initialValues:{email:"",password:"",rememberMe:!1},onSubmit:Ne,validationSchema:De,validateOnChange:!1},({values:He,errors:Ce,handleChange:Re})=>e.createElement(C.l0,{noValidate:!0},e.createElement(be.sg,null,e.createElement(i.Z,null),e.createElement(v.x,{paddingTop:6,paddingBottom:1},e.createElement(u.Z,{variant:"alpha",as:"h1"},oe({id:"Auth.form.welcome.title",defaultMessage:"Welcome!"}))),e.createElement(v.x,{paddingBottom:7},e.createElement(u.Z,{variant:"epsilon",textColor:"neutral600"},oe({id:"Auth.form.welcome.subtitle",defaultMessage:"Log in to your Strapi account"}))),Ce.errorMessage&&e.createElement(u.Z,{id:"global-form-error",role:"alert",tabIndex:-1,textColor:"danger600"},Ce.errorMessage)),e.createElement(f.k,{direction:"column",alignItems:"stretch",gap:6},e.createElement(g.o,{error:Ce.email?oe({id:Ce.email,defaultMessage:"This value is required."}):"",value:He.email,onChange:Re,label:oe({id:"Auth.form.email.label",defaultMessage:"Email"}),placeholder:oe({id:"Auth.form.email.placeholder",defaultMessage:"kai@doe.com"}),name:"email",required:!0}),e.createElement(Se,{error:Ce.password?oe({id:Ce.password,defaultMessage:"This value is required."}):"",onChange:Re,value:He.password,label:oe({id:"global.password",defaultMessage:"Password"}),name:"password",type:We?"text":"password",endAction:e.createElement(a.Z,{onClick:Ie=>{Ie.stopPropagation(),Qe(Oe=>!Oe)},label:oe(We?{id:"Auth.form.password.show-password",defaultMessage:"Show password"}:{id:"Auth.form.password.hide-password",defaultMessage:"Hide password"})},We?e.createElement(W.Z,null):e.createElement(j.Z,null)),required:!0}),e.createElement(N.X,{onValueChange:Ie=>{Re({target:{value:Ie,name:"rememberMe"}})},value:He.rememberMe,"aria-label":"rememberMe",name:"rememberMe"},oe({id:"Auth.form.rememberMe.label",defaultMessage:"Remember me"})),e.createElement(Z.z,{fullWidth:!0,type:"submit"},oe({id:"Auth.form.button.login",defaultMessage:"Login"}))))),Je),e.createElement(f.k,{justifyContent:"center"},e.createElement(v.x,{paddingTop:4},e.createElement(C.rU,{to:"/auth/forgot-password"},oe({id:"Auth.link.forgot-password",defaultMessage:"Forgot your password?"})))))};Te.defaultProps={children:null,onSubmit(){}},Te.propTypes={children:M().node,onSubmit:M().func,schema:M().shape({type:M().string.isRequired}).isRequired},p.Z=Te},33248:function(w,p,t){"use strict";t.r(p);var e=t(32735),g=t(27649),E=t(82055),v=t(17e3),u=t(9695),f=t(45509),N=t(8482),Z=t(25386),C=t(67879);const W=()=>{const{formatMessage:j}=(0,C.Z)();return(0,f.go)(),e.createElement(g.o,{labelledBy:"title"},e.createElement(E.T,{id:"title",title:j({id:"content-manager.pageNotFound",defaultMessage:"Page not found"})}),e.createElement(v.D,null,e.createElement(u.x,{action:e.createElement(f.Qj,{variant:"secondary",endIcon:e.createElement(N.Z,null),to:"/"},j({id:"app.components.NotFoundPage.back",defaultMessage:"Back to homepage"})),content:j({id:"app.page.not.found",defaultMessage:"Oops! We can't seem to find the page you're looging for..."}),hasRadius:!0,icon:e.createElement(Z.Z,{width:"10rem"}),shadow:"tableShadow"})))};p.default=W},63602:function(w,p,t){"use strict";var e=t(32735),g=t(45509),E=t(60216),v=t.n(E),u=t(53038);const f=({loadComponent:Z})=>{const[C,W]=(0,e.useState)(null);return(0,e.useEffect)(()=>{(async()=>{try{const X=await Z();W(()=>X.default)}catch(X){console.log(X)}})()},[Z]),C?e.createElement(C,null):e.createElement(g.dO,null)},N=(Z,C,W)=>e.createElement(u.AW,{render:()=>e.createElement(f,{loadComponent:Z}),key:C,path:C,exact:W||!1});f.propTypes={loadComponent:v().func.isRequired},p.Z=N},5074:function(w,p){"use strict";const t=({data:e})=>{try{return Object.keys(e).reduce((g,E)=>{const v=e[E][0];return g[E]={id:v,defaultMessage:v},g},{})}catch{return{}}};p.Z=t},90869:function(w,p,t){"use strict";t.d(p,{R6:function(){return E},ot:function(){return v.Z},Iz:function(){return u.Z},Pp:function(){return f},Qy:function(){return X},WW:function(){return N.Z}});var e=t(45509),E=async(T,M)=>{let q=null;try{await M.validate(T,{abortEarly:!1})}catch(Pe){q=(0,e.CJ)(Pe)}return q},v=t(63602),u=t(5074),f=(T,M="")=>[T,M].filter(q=>q).join(" "),N=t(18805),Z=t(98978);const C=T=>sortBy(T,M=>M.name);var W=null;const j={bufferToHex(T){return[...new Uint8Array(T)].map(M=>M.toString(16).padStart(2,"0")).join("")},async digestMessage(T){const M=new TextEncoder().encode(T),q=await crypto.subtle.digest("SHA-256",M);return this.bufferToHex(q)}};async function X(T){if(!T)return null;try{return await j.digestMessage(T.email)}catch{return null}}},18805:function(w,p){"use strict";const t=e=>e.filter((g,E,v)=>v.findIndex(u=>u.key===g.key)===E);p.Z=t},48224:function(w,p,t){var e={"./ar.json":[38677,7958],"./ca.json":[90169,3516],"./cs.json":[43186,7519],"./de.json":[8343,6901],"./dk.json":[65668,7898],"./en.json":[10329,320],"./es.json":[45445,8367],"./eu.json":[69511,8360],"./fr.json":[8399,8006],"./gu.json":[10182,2248],"./he.json":[21757,830],"./hi.json":[43206,6332],"./hu.json":[72320,5894],"./id.json":[74221,8897],"./it.json":[90685,6817],"./ja.json":[21727,1312],"./ko.json":[30986,1377],"./ml.json":[11309,9903],"./ms.json":[75973,3025],"./nl.json":[80381,2671],"./no.json":[82446,562],"./pl.json":[84008,7846],"./pt-BR.json":[91417,9647],"./pt.json":[41830,3340],"./ru.json":[57098,123],"./sa.json":[92900,9726],"./sk.json":[52204,606],"./sv.json":[43211,9303],"./th.json":[49582,749],"./tr.json":[99154,395],"./uk.json":[2987,7403],"./vi.json":[50576,3278],"./zh-Hans.json":[35964,2553],"./zh.json":[91999,1011]};function g(E){if(!t.o(e,E))return Promise.resolve().then(function(){var f=new Error("Cannot find module '"+E+"'");throw f.code="MODULE_NOT_FOUND",f});var v=e[E],u=v[0];return t.e(v[1]).then(function(){return t.t(u,19)})}g.keys=function(){return Object.keys(e)},g.id=48224,w.exports=g},47750:function(w,p,t){"use strict";w.exports=t.p+"70674f63fc3904c20de0.svg"}}]);
