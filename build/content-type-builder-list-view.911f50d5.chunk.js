"use strict";(self.webpackChunkstrapicms=self.webpackChunkstrapicms||[]).push([[5905],{3500:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>lt});var e=n(27279),C=n(42925),m=n(33110),j=n(6854),H=n(35750),g=n(68263),r=n(5816),M=n(57142),S=n(8766),D=n(76825),X=n(97367),N=n(98934),l=n.n(N),f=n(10131),T=n.n(f),b=n(6078),x=n.n(b),k=n(51943),z=n.n(k),I=n(61020),J=n(51447),G=n(63434),ge=n(42879),fe=n(65913),_=n(68388),Z=n(19915),Pe=n(50091),je=n(70627),o=n.n(je),V=n(27523),he=n(47558),v=n(90635),$=n(72450);const ye=$.ZP.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`,M=(0,C.ZP)(m.x)`
  ...
  width: 100%;
  border: none;
`,S=({children:D,icon:X,...N})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(j.i,{}),(0,e.jsx)(M,{as:"button",background:"primary100",padding:5,...N,children:(0,e.jsxs)(H.k,{children:[(0,e.jsx)(r,{"aria-hidden":!0,background:"primary200",children:X}),(0,e.jsx)(m.x,{paddingLeft:3,children:(0,e.jsx)(g.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:D})})]})})]})}}]);
